...
- [September 13 manual Cloud v29–v33: twelve-story diagnostic review](benchmark_reports/manual-v29-v33-cloud-production-2026-09-13.md)
- [v33 Cloud canary batch 1: outcomes, revisions and timing](benchmark_reports/step-19-cloud-v33-batch-1-2026-09-14.md)
- [v33 Cloud canary batch 2: results and retained semantic concerns](benchmark_reports/step-19-cloud-v33-batch-2-2026-09-14.md)
- [v33 Cloud canary: 12/12 completions and consolidated diagnostics](benchmark_reports/step-19-cloud-v33-consolidated-2026-09-14.md)
